...
const Prices = () => {
    const [selectedDirection, setSelectedDirection] = useState(data.directions[0].id)
    ...
    <div className="row">
        ...
        >
            <div 
                // style={{backgroundColor:`rgba(250, 230, 0, 0.7)`}}
            >
                            ...
                            >
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text fs-3 fw-bolder" style={{color: colors.blue}}>{ticket.price} руб</p>
